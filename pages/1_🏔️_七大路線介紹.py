...
with col1:
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            ...
            <th>天數</th>
            <th>挑戰難度</th>
            <th>季節 (<span style="color:blue">適合月份</span> 、 <span style="color:green">熱門月份</span> 、<span style="color:orange"> 淡季</span>、<span style="color:grey">人數較少</span>)</th>
        </tr>
        <tr>
            <td>法國之路</td>
            <td>771</td>
   ...
   """
    ...
    markdown = """
        ...
        ### 2. 葡萄牙之路 (Camino Portugués)
        
        葡萄牙的首都里斯本（Lisbon）是這條路的主要出發點，沿途會經過「古老的道路」、「森林」、「農田」、「橄欖樹林」、「葡萄園」和「歷史城鎮」，這些自然景觀不僅提供了美麗的視覺享受，還能讓朝聖者與大自然親密接觸。      
        <img src="https://chinchillaz.github.io/streamlit-hw//Camino/photos/2_portugal_UUU.jpg" width="1200"/>

        
        ---
        
        ### 3. 北方之路 (Camino del Norte)
        
        起點是位於西班牙北部的海濱城市聖塞巴斯蒂安（San Sebastien），沿途會穿越西班牙北部的海灘，再進入到寧靜的森林，於行走過程放鬆地享受大自然的魅力。  
        <img src="https://chinchillaz.github.io/streamlit-hw//Camino/photos/3_Norte_U.jpg" width="1200"/>
        
        ---
        
        ### 4. 原始之路 (Camino Primitivo)
        ...
        <img src="https://chinchillaz.github.io/streamlit-hw//Camino/photos/4_primitivo_U.jpg" width="1200"/>
        
        ---
        
        ### 5. 銀之路 (Via de la Plata)
        ...
        <img src="https://chinchillaz.github.io/streamlit-hw//Camino/photos/5_Via de la Plata_U.png" width="1200"/>
        
        ---
        
        ### 6. 英國之路 (Camino Inglés)
        ...
        ### 7. 世界盡頭之路 (Camino Finisterre-Muxía)
        
        許多朝聖者在抵達終點後，會決定將他們的旅程延伸到死亡之海（Costa da Morte）– 菲尼斯特雷（Finisterre），並在西班牙最西端的陡峭懸崖為這趟旅程畫下句點。  
        <img src="https://chinchillaz.github.io/streamlit-hw//Camino/photos/7_Muxia_UU.jpg" width="1200"/>
